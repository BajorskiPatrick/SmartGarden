...
#define QUEUE_SIZE 50 // Rozmiar kolejki wiadomości

bool water_alert_sent = false;

// Flaga stanu połączenia MQTT i uchwyt kolejki
bool is_mqtt_connected = false;
QueueHandle_t telemetry_queue = NULL;

// Zmienna globalna reprezentująca klienta MQTT
esp_mqtt_client_handle_t client = NULL;

// Struktura do przechowywania danych w buforze
typedef struct {
    int soil_moisture;
    float temp;
    float humidity;
